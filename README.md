...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/darktrap)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/darktrap
```

A live public deployment of this template is available at [https://darktrap.templates.workers.dev](https://darktrap.templates.workers.dev)
